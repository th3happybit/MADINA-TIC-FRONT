...
import { Modal, Button, Icon, ModalContent, Form, Input } from "semantic-ui-react";
...
const ModalComplement = (props) => {
    ...
    const handlecomplement = () => {
        if ((motif) && (motif !== ""))
            props.complement(props.data, motif);
        else
            setError(true)
    }
    ...
    return (
        <Modal
            ...
            trigger={
                <>
                    <Button onClick={handleopen} animated color="orange" className="_hidden_on_mobile">
                ...
                <ModalContent className="details_content">
                    ...
                    <div className="_redirection_content">
                        <Form.Field
                            ...
                            error={error ? { content: "This field can't be empty", pointing: "above" } : false}
                        />
                    </div>
                </ModalContent>
                <ModalContent className="content_modal_btns">
                    <Button animated color="blue" className="_primary" onClick={handlecomplement}>
