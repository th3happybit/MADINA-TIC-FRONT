        ...
        <Modal
            ...
            trigger={
                <Button.Group onClick={handleopen} className="infos_button">
                    ...
                    <Button className="shadow btn_account_detail pointer _show_on_mobile" content="Account details" />
                </Button.Group>
            }
        >
            <Modal.Content>
                ...
                {!is_approved && (
                    <Modal.Content
                        ...
                        d_uid={uid}
                    >
                        <Button className="button_primary" onClick={handelApp}>Approve</Button>
                        <Button className="button_secondary" onClick={handleclose}>Reject</Button>
                    </Modal.Content>
                )}
            </Modal.Content>
        </Modal>
