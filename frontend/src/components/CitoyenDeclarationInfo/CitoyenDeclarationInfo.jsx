      ...
      {id ?
        <>
          ...
          <div className="d-flex _info_container">
            <div className="_row1">
              ...
              {Data.status && getStatus(Data.status).status === "Lack of infos" &&
                <p className="_content2">Cause of complement demand : {Reason}</p>}
          ...
          <div className="_button1">
            {Data.status && (getStatus(Data.status).status === "Not Validated" || getStatus(Data.status).status === "Draft") && (
            ...
            {Data.status && getStatus(Data.status).status === "Lack of infos" && (
              <Link to={{ pathname: "/complement/declaration", state: { data: Data } }}>
